...
If I had the opportunity to advise the company, I would start by telling them the benefits of real estate investments, Stock Options, futures, and Cryptocurrency. Real estate investments are normally very hard to liquify and long-term investments, but with PropTech it has made it easier to calculate future earnings from these types of investments. In terms of offering futures and stock options, these should be put into a higher risk portfolio that they can offer more aggressive investors. With machine learning technologies they can make more accurate predictions of the potential returns. Lastly cryptocurrency, these are highly volatile investments, but with the right machine learning algorithms they can yield very high returns. All the products mentioned above should be put into a high-risk portfolio where customers are warned of the risks involved. This way customers not only have the option to delve in these markets but also know the consequences.

* Why do you think that offering this product or service would benefit the company?

Offering these products would benefit the company because it would help them stay competitive to the other companies while also increasing their revenue. Cryptocurrency for example is being offered by fast growing companies like Coinbase and RobinHood, so it is only logical that Betterment grew their own service line. Moreover, cryptocurrency has become a huge market where high returns can be achieved if invested correctly. With the machine learning technology, it has become easier to predict when to buy these volatile coins and when to sell. Betterment already has the technology; and if properly invested a customer can build a powerful portfolio with these coins alone. 

* What technologies would this additional product or service utilize?

The technologies that would be used for these types of investments would be Proptech for the real-estate investments, fine-tuned machine learning algorithms for the futures and options, and a specialized set of algorithms for the cryptocurrencies. As I mentioned earlier, Betterment already has the technology for most these tools; it would just be a matter of fine tuning them to work for these types of investments. Going back to cryptocurrencies, they are known to be extremely volatile, but they still follow a pattern, nonetheless. For some coins the pattern is seasonal while others are more tethered to the behavior of the market. In all cases, a proper algorithm can decipher these patterns and better equip the customer to minimize risk as much as possible. 

* Why are these technologies appropriate for your solution?

These technologies are appropriate for my solution because fintech industry is growing. As new technology arrives, new companies will emerge. Just like Betterment changing the game of investment back in 2010, so can any other company in the near future. That is why for Betterment to stay on top it needs to keep up with technology as well as the products and services it offers. If they don’t then they will make the same mistake as the companies that got left behind for not keeping up with the new technological advancements. 
...
Mercadante, Kevin. “Should I Invest My Money with Betterment in 2020?” Best Wallet Hacks, 13 Feb. 2020, [wallethacks.com/betterment-review/](wallethacks.com/betterment-review/).
